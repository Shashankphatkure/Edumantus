  ...
  const sections = [
    {
      ...
      content: `By accessing and using Edmantus's website and services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our services.`
    },
    {
      title: "2. Services Description",
      content: `Edmantus provides online mental health consultation services connecting users with licensed mental health professionals. Our services include but are not limited to:
• Video consultations
• Chat-based therapy
• Resource materials
• Self-help tools
